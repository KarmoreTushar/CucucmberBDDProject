...
public class SeleniumUtility {
	 ...
	 */
	{
		filePath = "G:\\Software Testing\\Workspace\\SwagLabsProject\\src\\test\\resources\\testData\\config.properties";
	}
	...
	public Logger getLogs(String name) {
		Logger logs=LogManager.getLogger(name);
		return logs;
	}
